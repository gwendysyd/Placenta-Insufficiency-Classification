...
\item Image augmentation: Tested with and without image augmentation.
\item Class weights: tuned as hyperparameter.
\item Placental planes: Anterior, posterior, combined.
\item Mask size: 1:1.
\end{itemize}
